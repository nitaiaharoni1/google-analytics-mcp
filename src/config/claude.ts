...
/**
 * Merge google-analytics-mcp configuration into existing Claude config
 */
export function mergeClaudeConfig(
  ...
  try {
    ...
    // Merge google-analytics-mcp server configuration
    existingConfig.mcpServers["google-analytics-mcp"] =
      newConfig.mcpServers["google-analytics-mcp"];
